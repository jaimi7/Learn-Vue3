...
const schema = Yup.object({
  'first-name': Yup.string().required('Please enter first name').max(10),
  'last-name': Yup.string().required().max(10),
  dob: Yup.date().required(),
  email: Yup.string().required().email(),
  'phone-number': Yup.number().required().positive().integer('Please enter only integer number.'),
      ...
      <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
        <div>
          ...
          <div class="mt-2.5">
            ...
            />
            <ErrorMessage name="first-name" class="text-red-800" />
          </div>
        </div>
        <div>
          <label
          ...
          <div class="mt-2.5">
            <Field
              ...
              class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
            />
            <ErrorMessage name="last-name" class="text-red-800" />
          </div>
        </div>
        <div class="sm:col-span-2">
          ...
          <div class="mt-2.5">
            <Field
              ...
              class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
            />
            <ErrorMessage name="dob" class="text-red-800" />
          </div>
        </div>
        <div class="sm:col-span-2">
        ...
        <div class="sm:col-span-2">
          ...
          <div class="relative mt-2.5">
            ...
            />
            <ErrorMessage name="phone-number" class="text-red-800" />
          </div>
        </div>
        <div class="sm:col-span-2">
          ...
          <div class="mt-2.5">
            ...
            <ErrorMessage name="message" class="text-red-800" />
          </div>
        </div>
      </div>
      <div class="mt-10">
